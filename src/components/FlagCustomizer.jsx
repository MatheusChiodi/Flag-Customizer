...
function FlagCustomizer({ flagOptions, setFlagOptions }) {
  ...
  return (
    ...
    >
      ...
      >
        <Flag color="#ff5555" /> {t("FlagCustomizer.title")}
      </motion.h2>
      ...
      >
        ...
        <input
          ...
          placeholder={t("FlagCustomizer.placeholderFlagText")}
        />
      </motion.div>
      ...
      >
        ...
        >
          <option value="round">
            {t("FlagCustomizer.optionRound")}
          </option>
          <option value="square">
            {t("FlagCustomizer.optionSquare")}
          </option>
        </select>
      </motion.div>
    </motion.div>
